...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Ошибка расчёта теста на одинаковые подряд идущие биты для с++: ", e) 
    ...
    try:
        ...
        print("Ошибка расчёта теста на самую длинную последовательность единиц в блоке для с++: ", e) 
